    ...
    <body onload="time()" class="app sidebar-mini rtl">
        ...
        <aside class="app-sidebar">
            ...
            <ul class="app-menu">
                ...
                <li><a class="app-menu__item" href="https://docs.google.com/spreadsheets/d/13dEivn63TmYIbo36wTtAdS7cbjrCNSQ_OrBhJg4QZR0/edit?usp=sharing" target="_blank"><i class='app-menu__icon bx bx-task'></i><span
