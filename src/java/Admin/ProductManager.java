        ...
        try {
            ...
            if (user.getIsAdmin().equalsIgnoreCase("true")) {
                ...
                if (action.equalsIgnoreCase("insertproduct")) {
                    ...
                    String uploadPath = new StringBuilder(getServletContext().getRealPath("/")).delete(length - 10, length - 4).toString() + "images";
                    ...
                    for (Part part : request.getParts()) {
                        ...
                        if (!fileName.equals("default.file") && !fileName.trim().isEmpty()) {
                            part.write(uploadPath + File.separator + fileName);
                            break;
                        }
                    }
                    String product_img = "images/" + fileName;
